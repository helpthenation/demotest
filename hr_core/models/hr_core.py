...
component_type = [('basic_pay', 'Basic Pay'),
                  ...
                  ('housing_allowance', 'Housing Allowance'), ('special_allowances', 'Special Allowances'),
                  ('social_allowance', 'Social Allowance'), ('education', 'Education'), ('children', 'Children'),
...
class HrCompensation(models.Model):
    ...
    def create(self, vals):
        ...
        log = 'Component Line Created: ' + (
            vals.get('component_description') if vals.get(
                'component_description') is not None else rec.component_description) + " : "
        log_post = False
